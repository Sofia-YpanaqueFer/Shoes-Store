...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post shoes_url, params: { shoe: { brand_id: @shoe.brand_id, category_id: @shoe.category_id, name: @shoe.name, picture: @shoe.picture, rating: @shoe.rating, year: @shoe.year } }
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { brand_id: @shoe.brand_id, category_id: @shoe.category_id, name: @shoe.name, picture: @shoe.picture, rating: @shoe.rating, year: @shoe.year } }
